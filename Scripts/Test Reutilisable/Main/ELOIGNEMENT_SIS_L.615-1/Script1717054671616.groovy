...
//ELOIGNEMENT-ITF-1 : Dossier de l'usager : page control + prendre une mesure d'éloignement
//'cet exemple SIS_L.615-1 soit "Exécution fiche SIS L.615-1" (autres valeurs possibles :  ; Expulsion ; IAT ; ITF ; Remise Schengen ; Transfert Dublin
...
//WebUI.click(findTestObject('null'))
WebUI.selectOptionByLabel(findTestObject('null'), "SIS_L.615-1", true)
