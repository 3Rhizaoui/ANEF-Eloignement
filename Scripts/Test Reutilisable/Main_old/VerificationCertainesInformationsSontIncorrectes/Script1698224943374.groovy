...
MsgAlertPresent = WebUI.verifyElementVisible(findTestObject('null'), FailureHandling.OPTIONAL)

if(MsgAlertPresent){
	TextAlert = WebUI.getText(findTestObject('null'),FailureHandling.OPTIONAL)
