...
//ELOIGNEMENT-IAT-1 : Dossier de l'usager : page control + prendre une mesure d'éloignement
//'cet exemple IAT (autres valeurs possibles : Exécution fiche SIS L.615-1 ; Expulsion ; IAT ; ITF ; Remise Schengen ; Transfert Dublin
...
//WebUI.click(findTestObject('null'))
WebUI.selectOptionByLabel(findTestObject('null'), "IAT", true)
